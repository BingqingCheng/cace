...
class Batch(Data):
    ...
    def __init__(self, 
        ...
        # super().__init__(x=x, edge_index=edge_index, edge_attr=edge_attr, y=y, num_nodes=num_nodes,
        #                  pos=pos, normal=normal, face=face)
        #added, super is not supported in torchscript
    ...
    def from_data_list(cls, data_list, follow_batch=[], exclude_keys=[]):
        ...
        # # revised, Replace try-except with conditional check
